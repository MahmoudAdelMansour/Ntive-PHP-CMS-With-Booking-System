    ...
    <div class="content-companies">
        ...
        <div class="formContainer">
            <form method="post" class="add-form" id="add-companies-form" enctype="multipart/form-data">
                <div class="avaarea">
                    <input class="add-companies-input companies-all-inputs up-input" type="file"
                        name="companiesavataradd" accept=".png,.gif,.jpg,.webp" placeholder="اختار صورة مناسبة"
                        id="companiesavataradd" autocomplete="off" />

                    <img class="inputs-companies-upload" src="images/avatar.png" alt="" srcset="">
                    <span class="inputs-companies-upload">اختيار صورة</span>
                </div>
                <input class="add-companies-input companies-all-inputs" type="text" name="companiesnameadd"
                    placeholder="اسم الشركة" id="companiesnameadd" autocomplete="off" />
                <input class="add-companies-input companies-all-inputs" type="text" name="companieslinkadd"
                    placeholder="رابط الشركة" id="companieslinkadd" autocomplete="off" />
