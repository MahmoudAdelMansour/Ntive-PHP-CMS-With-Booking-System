    ...
    <div class="content-chief">
        ...
        <div class="formContainer">
            <form method="post" class="edit-form" id="edit-chief-form" enctype="multipart/form-data">
                <div class="avaarea">
                    <input
                    class="edit-chief-input up-input chief-all-inputs"
                    type="file"
                    name="chiefavataredit"
                    placeholder="اختار صورة مناسبة"
                    id="chiefavatarup"
                    autocomplete="off"
                    />
                    ...
                    <input
                    class="edit-chief-input chief-all-inputs"
                    type="text"
                    name="chiefakaedit"
                    placeholder="لقب الرئيس التنفيذي الجديد"
                    id="chiefakaedit"
                    autocomplete="off"/>
                    <input
                class="edit-chief-input chief-all-inputs"
                    type="text"
                    name="chiefnameedit"
                    placeholder="اسم الرئيس التنفيذي الجديد"
                    id="chiefnameedit"
                    autocomplete="off"/>
