  ...
  <div class="content-companies">
    ...
    <div class="formContainer">
      <form method="post" class="edit-form" id="edit-companies-form" enctype="multipart/form-data">
        <div class="avaarea">
          <input class="edit-companies-input up-input companies-all-inputs" type="file" name="companiesavataredit" placeholder="اختار صورة مناسبة" id="companiesavatarup" autocomplete="off" />

          <img class="inputs-companies-upload" src="images/avatar.png" alt="" srcset="">
          <span class="inputs-companies-upload">اختيار صورة</span>
        </div>
        <input class="edit-companies-input companies-all-inputs" type="text" name="companiesnameedit" placeholder="اسم الشركة الجديد" id="companiesnameedit" autocomplete="off" />
        <input class="edit-companies-input companies-all-inputs" type="text" name="companieslinkedit" placeholder="رابط الشركة الجديد" id="companieslinkedit" autocomplete="off" />
