  ...
  <div class="content-booking">
    ...
    <div class="formContainer">
      <form method="post" class="edit-form" id="edit-booking-form" enctype="multipart/form-data">
        ...
        <input class="edit-booking-input booking-all-inputs" type="text" name="bookingnameadd" placeholder="اسم الحجز" id="bookingnameadd" autocomplete="off" require />
        <!-- *********** -->
        <input class="edit-booking-input booking-all-inputs" type="tel" name="bookingphoneadd" placeholder="رقم الهاتف" id="bookingphoneadd" autocomplete="off" pattern="[0-9]{3}[0-9]{3}[0-9]{3}[0-9]{2}" />
        <!-- *********** -->
        <input class="edit-booking-input booking-all-inputs" type="date" name="bookingdateadd" placeholder="تاريخ الحجز" id="bookingdateadd" autocomplete="off" />
        <!-- *********** -->
        <input class="edit-booking-input booking-all-inputs" type="time" name="bookingtimeadd" placeholder="وقت الحجز" id="bookingtimeadd" autocomplete="off" />
        <!-- *********** -->
        ...
        <div class="radios-user">
          ...
          <input class="edit-booking-input booking-all-inputs" type="radio" name="bookingstatus" placeholder="مفعل" id="bookingstatuson" autocomplete="off" require value="0" />
        </div>
        <!-- *********** -->
        <div class="radios-mng">
          <label for="bookingstatusoff">غير مفعل</label>
          <input class="edit-booking-input booking-all-inputs" type="radio" name="bookingstatus" placeholder="غير مفعل" id="bookingstatusoff" autocomplete="off" require value="1" />
        </div>
      </form>
    </div>
